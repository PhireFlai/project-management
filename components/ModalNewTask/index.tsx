        ...
        <Modal isOpen={isOpen} onClose={onClose} name="Create New Task">
            ...
            >
                ...
                <select
                    ...
                    <option value={Status.WIP}>Work In Progress</option>
                ...
                <div className='grid grid-cols-1 gap sm::grid-cols-2 sm:gap-2'>
                ...
                <input type="text" className={inputStyles} placeholder='Author ID' value={authorUserId} onChange={(e) => setAuthorUserId(e.target.value)} />
                <input type="text" className={inputStyles} placeholder='Assigned ID' value={assignedUserId} onChange={(e) => setAssignedUserId(e.target.value)} />

                <button type='submit'
                    className={`mt-4 flex w-full justify-center rounded-md border border-transparent bg-blue-primary px-4 py-2 text-base font-medium
                     text-white shadow-sm hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:offset-2
                     ${!isFormValid() || isLoading ? "curosr-not-allowed opacity-50" : ""}`}
