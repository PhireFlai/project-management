...
const TaskColumn = ({
    ...
    return (
        <div ref={(instance) => {
            ...
            className={`sl:py-4 rounded-lg py-2 px-4 ${isOver ? "bg-blue-100 dark:bg-neutral-750" : ""}`}>
            ...
            <div className='mb-3 flex w-full'>
                ...
                <div className="flex w-full items-center justify-between rounded-e-lg bg-white px-5 py-4 dark:bg-dark-secondary">
                    <h3 className='flex items-center text-lg font-semibold dardk:text-white'>
                        {status}{" "}

                        <span className='ml-1 inline-block rounded-full bg-gray-200 p-1 text-center text-sm leading-none dark:bg-dark-tertiary'
    ...
    return (
        <div ref={(instance) => {
            ...
            <div className='p-4 md:p-6'>
                ...
                <div className='text-xs text-gray-500 dark:text-neutral-50'>
                ...
                <div className='mt-3 flex items-center justify-between'>
                    <div className='flex -space-x-[6px[ overflow-hidden'>
                        {task.assignee && (
                            <Image src={task.assignee.userId}
